...
sealed class AddServiceEvent{
    ...
    data class UpdateMyAddressListDialog(val status: Boolean) : AddServiceEvent()
    data class UpdateSubCategoryListDialog(val status: Boolean) : AddServiceEvent()
    ...
    data object SuccessfullyAddService : AddServiceEvent()
